...
(0, _catApi.fetchBreeds)().then(renderBreeds);
...
},{"./cat-api":"d7YdZ"}],"d7YdZ":[function(require,module,exports,__globalThis) {
...
'use strict';
const API_KEY = 'live_o5CHuOICqm6d78WBdVHJcC0RU8oyfcw2Ejqg8y1s4Qvimp0N51X19qtTF4fdtGRK';
const headers = {
    'x-api-key': API_KEY
};
const fetchData = (url)=>{
...
const fetchCatByBreed = (breedId)=>{
    return fetchData(`https://api.thecatapi.com/v1/images/search?breed_ids=${breedId}`);
};
